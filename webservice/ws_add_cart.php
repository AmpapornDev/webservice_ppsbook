...
$sql_check = "select id_book,qty_book,id_member from tb_cart_order where id_book = '".$var_id_book."' and id_member = '".$var_id_member."'";
...
if ( $count > 0 ) {
        ...
        $sql_update = "update tb_cart_order set qty_book = '".$sum_qty."' where id_book = '".$var_id_book."' and id_member = '".$var_id_member."'";
